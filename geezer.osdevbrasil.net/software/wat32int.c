/*****************************************************************************
Software and hardware interrupt handler demo
using 32-bit Watcom C with CauseWay DOS extender
...
void hook_8259(vector_t *v);
void unhook_8259(vector_t *v);
/*****************************************************************************
*****************************************************************************/
...
/*****************************************************************************
*****************************************************************************/
void __interrupt syscall_int(union INTPACK r)
{
...
/* passing pointer out of software interrupt handler */
	r.x.edi = (int)farewell;
}
/*****************************************************************************
*****************************************************************************/
void __interrupt timer_irq(void)
{
