...
;;;
(ext:file-comment
  "$Header: /afs/cs/project/clisp/src/beta/motif/lisp/RCS/initial.lisp,v 1.4 1994/10/28 22:34:45 ram Exp $")
;;;
;;; **********************************************************************
;;;
...
(defpackage "TOOLKIT-INTERNALS"
  ...
  (:export "*MOTIF-CONNECTION*" "*X-DISPLAY*" "MOTIF-CONNECTION"
	   ...
	   "MOTIF-CONNECTION-EVENT-TABLE" "MOTIF-CONNECTION-TIMER-TABLE"
	   "TOOLKIT-ERROR"
...
(defpackage "TOOLKIT"
  ...
  (:export "ADD-CALLBACK" "REMOVE-CALLBACK" "REMOVE-ALL-CALLBACKS"
	   ...
	   "WITH-CALLBACK-DEFERRED-ACTIONS" "ADD-TIMEOUT" "REMOVE-TIMEOUT"))
