...
|                                                                        |
|   CHECK.C                                                     05.12.88 |
|   PAMAKE Utility:  Check structures                                    |
|                                                                        |
*************************************************************************/
...
struct name *           np;
{
    ...
    if (np->n_flag & N_MARK)
        fatal("Circular dependency found involving %s", np->n_name);
