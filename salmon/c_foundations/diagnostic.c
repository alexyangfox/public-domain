...
/*
 *  This file contains the implementation of code for handling diagnostic
 *  messages.
 *
...
#define INIT_OPEN_TEXT_BUFFER_CHARS 10


static void handle_message(diagnostic_kind kind, boolean has_message_number,
        ...
        const char *format, ...);
static void vhandle_message(diagnostic_kind kind, boolean has_message_number,
        size_t message_number, const char *file_name, boolean has_line_number,
        size_t line_number, boolean has_column_number, size_t column_number,
        boolean has_character_count, size_t character_count,
        const char *format, va_list arg);
static void default_handler(void *data, diagnostic_kind kind,
...
static char *kept_file_name = NULL;
static boolean have_kept_line_number = FALSE;
static size_t kept_line_number = 0;
static boolean have_kept_column_number = FALSE;
static size_t kept_column_number = 0;
static boolean have_kept_character_count = FALSE;
static size_t kept_character_count = 0;
static boolean have_open_message = FALSE;
static diagnostic_kind open_kind;
static boolean have_open_message_number;
static size_t open_message_number;
static boolean open_text_buffer_has_been_initialized = FALSE;
static string_buffer open_text_buffer;
static size_t open_text_buffer_position;
static void *handler_data = NULL;
static void (*handler_function)(void *data, diagnostic_kind kind,
        boolean has_message_number, size_t message_number,
        const char *file_name, boolean has_line_number, size_t line_number,
        boolean has_column_number, size_t column_number,
        boolean has_character_count, size_t character_count,
        const char *format, va_list arg) = &default_handler;
...
extern void basic_error(const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_ERROR, FALSE, 0, kept_file_name, have_kept_line_number,
            kept_line_number, have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void basic_warning(const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_WARNING, FALSE, 0, kept_file_name,
            have_kept_line_number, kept_line_number, have_kept_column_number,
            kept_column_number, have_kept_character_count,
            kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void basic_notice(const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_NOTICE, FALSE, 0, kept_file_name, have_kept_line_number,
            kept_line_number, have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void vbasic_error(const char *format, va_list arg)
  {
    vhandle_message(DK_ERROR, FALSE, 0, kept_file_name, have_kept_line_number,
            kept_line_number, have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, arg);
  }
...
extern void vbasic_warning(const char *format, va_list arg)
  {
    vhandle_message(DK_WARNING, FALSE, 0, kept_file_name,
            have_kept_line_number, kept_line_number, have_kept_column_number,
            kept_column_number, have_kept_character_count,
            kept_character_count, format, arg);
  }
...
extern void file_line_error(const char *file_name, size_t line_number,
                            const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_ERROR, FALSE, 0, file_name, TRUE, line_number,
            have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void file_line_warning(const char *file_name, size_t line_number,
                              const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_WARNING, FALSE, 0, file_name, TRUE, line_number,
            have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void file_line_notice(const char *file_name, size_t line_number,
                             const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_NOTICE, FALSE, 0, file_name, TRUE, line_number,
            have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void file_character_error(const char *file_name, size_t line_number,
                                 size_t column_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_ERROR, FALSE, 0, file_name, TRUE, line_number, TRUE,
            column_number, have_kept_character_count, kept_character_count,
            format, ap);
    va_end(ap);
  }
...
extern void file_character_warning(const char *file_name, size_t line_number,
        size_t column_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_WARNING, FALSE, 0, file_name, TRUE, line_number, TRUE,
            column_number, have_kept_character_count, kept_character_count,
            format, ap);
    va_end(ap);
  }
...
extern void file_character_notice(const char *file_name, size_t line_number,
        size_t column_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_NOTICE, FALSE, 0, file_name, TRUE, line_number, TRUE,
            column_number, have_kept_character_count, kept_character_count,
            format, ap);
    va_end(ap);
  }
...
extern void file_selection_error(const char *file_name, size_t line_number,
        size_t column_number, size_t character_count, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_ERROR, FALSE, 0, file_name, TRUE, line_number, TRUE,
                    column_number, TRUE, character_count, format, ap);
    va_end(ap);
  }
...
extern void numbered_error(size_t message_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_ERROR, TRUE, message_number, kept_file_name,
            have_kept_line_number, kept_line_number, have_kept_column_number,
            kept_column_number, have_kept_character_count,
            kept_character_count, format, ap);
    va_end(ap);
...
extern void numbered_warning(size_t message_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_WARNING, TRUE, message_number, kept_file_name,
            have_kept_line_number, kept_line_number, have_kept_column_number,
            kept_column_number, have_kept_character_count,
            kept_character_count, format, ap);
    va_end(ap);
...
extern void numbered_notice(size_t message_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_NOTICE, TRUE, message_number, kept_file_name,
            have_kept_line_number, kept_line_number, have_kept_column_number,
            kept_column_number, have_kept_character_count,
            kept_character_count, format, ap);
    va_end(ap);
...
extern void numbered_file_line_error(size_t message_number,
        const char *file_name, size_t line_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_ERROR, TRUE, message_number, file_name, TRUE,
            line_number, have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void numbered_file_line_warning(size_t message_number,
        const char *file_name, size_t line_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_WARNING, TRUE, message_number, file_name, TRUE,
            line_number, have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void numbered_file_line_notice(size_t message_number,
        const char *file_name, size_t line_number, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_NOTICE, TRUE, message_number, file_name, TRUE,
            line_number, have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void numbered_file_character_error(size_t message_number,
        ...
        const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_ERROR, TRUE, message_number, file_name, TRUE,
            line_number, TRUE, column_number, have_kept_character_count,
            kept_character_count, format, ap);
    va_end(ap);
  }
...
extern void numbered_file_selection_error(size_t message_number,
        ...
        size_t character_count, const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(DK_ERROR, TRUE, message_number, file_name, TRUE,
            line_number, TRUE, column_number, TRUE, character_count, format,
            ap);
    va_end(ap);
  }
...
extern void set_diagnostic_source_file_name(const char *file_name)
  {
    ...
    if ((kept_file_name == NULL) ||
        (strlen(kept_file_name) < strlen(file_name)))
      {
        if (kept_file_name != NULL)
            free(kept_file_name);
        kept_file_name = MALLOC_ARRAY(char, strlen(file_name) + 1);
        if (kept_file_name == NULL)
            return;
      }

    strcpy(kept_file_name, file_name);
  }
...
extern void set_diagnostic_source_line_number(size_t line_number)
  {
    have_kept_line_number = TRUE;
    kept_line_number = line_number;
  }

extern void unset_diagnostic_source_line_number(void)
  {
    have_kept_line_number = FALSE;
    kept_line_number = 0;
  }

extern void set_diagnostic_source_column_number(size_t column_number)
  {
    have_kept_column_number = TRUE;
    kept_column_number = column_number;
  }

extern void unset_diagnostic_source_column_number(void)
  {
    have_kept_column_number = FALSE;
    kept_column_number = 0;
  }

extern void set_diagnostic_source_character_count(size_t character_count)
  {
    have_kept_character_count = TRUE;
    kept_character_count = character_count;
  }

extern void unset_diagnostic_source_character_count(void)
  {
    have_kept_character_count = FALSE;
    kept_character_count = 0;
  }

extern void open_error(void)
  {
    assert(!have_open_message);
    have_open_message = TRUE;
    open_kind = DK_ERROR;
    have_open_message_number = FALSE;
    open_message_number = 0;
    if (!open_text_buffer_has_been_initialized)
      {
        verdict the_verdict;

        the_verdict = string_buffer_init(&open_text_buffer,
                                         INIT_OPEN_TEXT_BUFFER_CHARS);
        if (the_verdict == MISSION_ACCOMPLISHED)
            open_text_buffer_has_been_initialized = TRUE;
      }
    else
      {
        open_text_buffer.element_count = 0;
      }
    open_text_buffer_position = 0;
  }
...
extern void assign_diagnostic_number(size_t message_number)
  {
    assert(have_open_message);
    have_open_message_number = TRUE;
    open_message_number = message_number;
  }
...
extern void vdiagnostic_text(const char *format, va_list arg)
  {
    ...
    if (!open_text_buffer_has_been_initialized)
        return;
    vbuffer_printf(&open_text_buffer, open_text_buffer_position, format, arg);
    assert(open_text_buffer.element_count > 0);
    open_text_buffer_position = open_text_buffer.element_count - 1;
  }

extern void close_diagnostic(void)
  {
    assert(have_open_message);
    handle_message(open_kind, have_open_message_number, open_message_number,
            kept_file_name, have_kept_line_number, kept_line_number,
            have_kept_column_number, kept_column_number,
            have_kept_character_count, kept_character_count, "%s",
            open_text_buffer.array);
    have_open_message = FALSE;
  }
...
extern void cleanup_diagnostic(void)
  {
    if (open_text_buffer_has_been_initialized)
      {
        open_text_buffer_has_been_initialized = FALSE;
        free(open_text_buffer.array);
      }
  }
...
static void handle_message(diagnostic_kind kind, boolean has_message_number,
        ...
        const char *format, ...)
  {
    ...
    va_start(ap, format);
    vhandle_message(kind, has_message_number, message_number, file_name,
            has_line_number, line_number, has_column_number, column_number,
            has_character_count, character_count, format, ap);
    va_end(ap);
  }
...
static void vhandle_message(diagnostic_kind kind, boolean has_message_number,
        ...
        const char *format, va_list arg)
  {
    assert(handler_function != NULL);

    (*handler_function)(handler_data, kind, has_message_number, message_number,
            file_name, has_line_number, line_number, has_column_number,
            column_number, has_character_count, character_count, format, arg);
  }
...
static void default_handler(void *data, diagnostic_kind kind,
        ...
        const char *format, va_list arg)
  {
    ...
    if (has_message_number)
        fprintf(stderr, " %lu", (unsigned long)message_number);
    fprintf(stderr, ": ");

    if ((file_name != NULL) || has_line_number || has_column_number ||
        has_character_count)
      {
        ...
        if (has_line_number)
          {
            if (comma_needed)
                fprintf(stderr, ", ");
            fprintf(stderr, "line %lu", (unsigned long)line_number);
            comma_needed = TRUE;
          }
        ...
        if (has_column_number)
          {
            if (comma_needed)
                fprintf(stderr, ", ");
            fprintf(stderr, "column %lu", (unsigned long)column_number);
            comma_needed = TRUE;
          }
        ...
        if (has_character_count)
          {
            if (comma_needed)
                fprintf(stderr, ", ");
            fprintf(stderr, "%lu characters", (unsigned long)character_count);
            comma_needed = TRUE;
          }
