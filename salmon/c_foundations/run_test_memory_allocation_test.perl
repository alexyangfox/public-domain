...
#   memory_allocation_test.{c,h} module.
#
...
#       Usage
#
#   This program is the driver for a suite of tests for the
#   memory_allocation_test module.  Before it can be used, the executable that
#   calls the C code tests must be built, using the Makefile,
#   test_memory_allocation_test.c, memory_allocation_test.h, and
#   memory_allocation_test.c.  The path to this executable must be provided to
#   this program as its first command-line argument.  This program then runs
#   that executable multiple times to run the various tests and compares the
...
my @test_table =
  (
    "no-errors", 0,
        "^\$",
    "leak", 0,
        "^\\\[.*\\\] Memory leak: A block of 3 bytes allocated here was " .
                "never freed.\n" .
        "\\\[.*\\\] Memory leak: A block of 2 bytes allocated here was never" .
                " freed.\n" .
        "\\\[.*\\\] Memory leak: A block of 1 byte allocated here was never " .
                "freed.\n\$",
    "write-after-free", 1 << 8,
        "^Memory allocation error: The memory in a deallocated block was written after it was deallocated.\n" .
        "Memory allocation error: Address with error: [0-9a-fA-FxX]+.\n" .
        "Memory allocation error: Expected value:     0xff.\n" .
        "Memory allocation error: Actual value:       0x05.\n" .
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n" .
        "Memory allocation error: This is 0 bytes into a block of 1 bytes starting at address [0-9a-fA-FxX]+.\n\$",
    "free-without-alloc", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: An attempt was made to free a " .
                "NULL pointer.\n\$",
    "free-static", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: A block with address " .
                "[0-9a-fA-FxX]+ was freed, but that address doesn't match " .
                "the address of any block that was ever allocated.\n\$",
    "free-on-stack", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: A block with address " .
                "[0-9a-fA-FxX]+ was freed, but that address doesn't match " .
                "the address of any block that was ever allocated.\n\$",
    "double-free", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: A block with address " .
                "[0-9a-fA-FxX]+ was freed twice.\n" .
        "\\\[.*\\\] Memory allocation error: It was freed the first time " .
                "here.\n" .
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n\$",
    "double-free2", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: A block with address " .
        ...
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n\$",
    "write-before", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: The memory before an allocated" .
                " block was written.\n" .
        "\\\[.*\\\] Memory allocation error: Address with error: " .
                "[0-9a-fA-FxX]+\n" .
        ...
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n\$",
    "write-after", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: The memory after an allocated " .
                "block was written.\n" .
        "\\\[.*\\\] Memory allocation error: Address with error: " .
                "[0-9a-fA-FxX]+\n" .
        "\\\[.*\\\] Memory allocation error: Expected value:     " .
    ...
    "write-after2", 1 << 8,
        ...
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n\$",
    "allocate-zero", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: An attempt was made to " .
                "allocate 0 bytes.\n\$",
    "allocate-huge", 0,
        "^\$",
    "bad-free-after-good", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: A block with address " .
                "[0-9a-fA-FxX]+ was freed, but that address doesn't match " .
                "the address of any block that was ever allocated.\n\$",
    "assert-zero-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: " .
                "assert_is_malloced_block_with_exact_size\\(\\) was called " .
                "with size zero specified.\n\$",
    "assert-bad-limit-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: It was asserted that a block " .
                "with address [0-9a-fA-FxX]+ had at least size 11, but that " .
                "block actually had size 10.\n" .
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n\$",
    "assert-bad-exact-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: It was asserted that a block " .
                "with address [0-9a-fA-FxX]+ had size 20, but that block " .
                "actually had size 10.\n" .
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n\$",
    "assert-null-limit-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: It was asserted that NULL was " .
                "a valid allocated block.\n\$",
    "assert-null-exact-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: It was asserted that NULL was " .
                "a valid allocated block.\n\$",
    "assert-bogus-limit-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: It was asserted that a block " .
                "with address [0-9a-fA-FxX]+ was a valid allocated block, " .
                "but that address doesn't match the address of any block " .
                "that was ever allocated.\n\$",
    "assert-bogus-exact-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: It was asserted that a block " .
                "with address [0-9a-fA-FxX]+ was a valid allocated block, " .
                "but that address doesn't match the address of any block " .
                "that was ever allocated.\n\$",
    "assert-freed-limit-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: It was asserted that freed " .
                "block [0-9a-fA-FxX]+ was a valid allocated block.\n" .
        "\\\[.*\\\] Memory allocation error: It was freed here.\n" .
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n\$",
    "assert-freed-exact-size", 1 << 8,
        "^\\\[.*\\\] Memory allocation error: It was asserted that freed " .
                "block [0-9a-fA-FxX]+ was a valid allocated block.\n" .
        "\\\[.*\\\] Memory allocation error: It was freed here.\n" .
        "\\\[.*\\\] Memory allocation error: It was allocated here.\n\$",
...
if ($ARGV[1] eq "")
  {
    print STDERR "Usage: run_test_memory_allocation_test.perl <executable> " .
                 "<logfile>\n";
    exit 1;
  }
`rm -f $ARGV[1]`;
run_all_tests($ARGV[0], $ARGV[1]);
print STDERR "All tests of the memory_allocation_test module passed.\n";
exit 0;
