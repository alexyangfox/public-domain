/* file "print_formatting.h" */

/*
 *  This file contains the interface to code to do the formatting of character
 *  output specified by a format string in the style of the ANSI-C printf()
...
#ifndef PRINT_FORMATTING_H
#define PRINT_FORMATTING_H
