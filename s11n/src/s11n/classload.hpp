...
namespace s11n {
		...
		*/
		...
		struct S11N_EXPORT_API object_factory
		{
			...
			/**
			   ...
			   Changed in 1.3.0: this now propogates exceptions
			   as-is, instead of re-wrapping certain exception
			   types as s11n_exceptions.
			*/
		...
		*/
                ...
                {
			::s11n::fac::factory<InterfaceBase>().alias( _alias, classname );
                }
