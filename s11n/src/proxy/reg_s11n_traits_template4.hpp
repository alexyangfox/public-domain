...
namespace s11n {
    ...
    /**
       ...
       template parameters.
    */
    template <S11N_TEMPLATE_TYPENAME_T1 T1, S11N_TEMPLATE_TYPENAME_T2 T2, S11N_TEMPLATE_TYPENAME_T3 T3, S11N_TEMPLATE_TYPENAME_T4 T4>
