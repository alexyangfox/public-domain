...
namespace s11nlite {
	...
	*/
	...
	/**
	   ...
	   API. This is guaranteed to return *some* object, except
	...
	*/
	void instance( client_interface * newinstance );
        ...
        /**
           ...
           The internally-supported serializers all support a "friendly
	   ...
	   DLL file extension (e.g. .dll, .so, or .dylib).
         */
	...
	*/
        ...
        */
        ...
        /**
           ...
           state then its deserialize operator would have returned
           true!).
        ...
        */
        ...
        /**
           Exactly like deserialize(), but operates on a subnode of
           src named subnodename. Returns 0 if no such subnode is
           found.
         */
        template <typename DeserializableT>
        ...
        /**
           Tries to load an S11nNode from src, then deserialize that
	...
	*/
	...
	/**
	   ...
	   - A non-cvp (const/volatile/pointer) qualified
	   s11nlite::node_type
	...
	*/
	...
	/**
	   ...
	   Prior to v1.3.1 this function was called load_node_nullary_string_f.
	   In 1.3.1 it was renamed for consistency with its cousins.
	*/
	struct load_node_string_nullary_f
	{
		...
		/**
		   ...
		   a filename).
		*/
		explicit load_node_string_nullary_f( std::string const & s ) : resource(s)
		{}
	...
	*/
	inline load_node_string_nullary_f
	load_node_nullary_f( std::string const & s )
	{
		return load_node_string_nullary_f(s);
	}
